...
export const PRODUCT_TABLES: Record<"ads" | "ga4" | "gsc" | "gtm", string[]> = {
...
export const FINDING_PRODUCT = { ads: "ads", ga4: "analytics", gsc: "search_console", gtm: "tag_manager" } as const;
